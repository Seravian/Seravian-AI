...
model_cache_volume = modal.Volume.from_name(
    "13b-model-cache-volume", create_if_missing=True
)
...
diagnosis_volume = modal.Volume.from_name(
    "13b-diagnosis-history-volume", create_if_missing=True
)
...
# Create a Modal Stub (this is your app)
diagnose_app = modal.App("13b-mentallama-diagnose")
# Model name to use
model_name = "klyang/MentaLLaMA-chat-13B"
model_path = "/13b_model"
chat_history_path = "/13b_chat-history"
diagnosis_path = "/13b_diagnosis-history"
